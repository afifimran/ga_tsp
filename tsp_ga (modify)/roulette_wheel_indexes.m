...
% 
% for i = 1:m
% candidates = randi(n,1,2); % select 2 random candidates
% [~, winner] = max(prn(candidates)); % determine the one with the higher probability
% ii(i) = candidates(winner); % store the index of the winner
% end
% 
% end